...
qnames = c("ICE-60", "CCPS", "NACC", "BHI", "AS", "POSO", "MPS", "EAS")
...
# qdata = filter(df, name != "demo-0-en" & sid %in% subjects$sid)
# 
...
newcolnames = paste("ICE-60-en", questionnaires[["ICE-60"]]$code, sep = ".")
